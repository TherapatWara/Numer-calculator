...
class QuardInterpolation extends React.Component
{
    ...
    InterpolationCalcFunction(P1,P2,P3,X)
    {
        ...
        if(p1!=null && p2!=null && x!=null)
        {
            ...
            var ans = c0+c1*(x-arr[p1-1].x)+c2*(x-arr[p1-1].x)*(x-arr[p2-1].x);
        ...
        return(
          ...
          <form onSubmit={this.handleSubmit}>
            <div className="bg-font">
                <div className="logo">
                    <h1>Interpolation Quardratic</h1>
...
export default QuardInterpolation